                                        ...
                                        @if (Auth::user()->utype == "ADM")
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="Coupon" href="{{route('admin.coupon')}}">Coupon</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="Dashboard" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit()">Logout</a>
                                                    </li>
                                                </ul>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-icon right-section">
							@livewire('render.wishlist-count-component')

							@livewire('render.cart-count-component')
