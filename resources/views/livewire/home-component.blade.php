                    ...
                    @foreach ($sale_products as $sale_product)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">${{$sale_product->sale_price}}</p></ins> <del><p class="product-price">${{$sale_product->sale_price}}</p></del></div>
                            </div>
                        </div>
                    @endforeach
                </div>
                                    ...
                                    @foreach ($latest_products as $latest_product)
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                ...
                                                @if ($latest_product->sale_price != null && $latest_product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                        ...
                                        @foreach ($c_products as $c_product)
                                            <div class="product product-style-2 equal-elem ">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    @if ($c_product->sale_price != null && $c_product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
